...
<main class="home">
    <div class="container">
      ...
      <section class="left-block">
        <div class="box">
          <h1 class="box__title" data-aos="fade-down" data-aos-delay="50"><?php echo get_field('name') ?></h1>
    ...
    <!-- <div class="container">
      <section class="slider-sec">
        <h2>Slider Slick</h2>
        <a href="https://kenwheeler.github.io/slick/">Ссылка Slick Slider</a>
        ...
        <ul class="slider">
          <li class="slider__item">
            <img src="img/slider/1.jpg" alt="" class="slider__img">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam saepe ipsum vel vitae fugiat ullam, explicabo commodi aperiam cum voluptas omnis provident quis dignissimos adipisci placeat dicta, eveniet ea. Pariatur?</p>
          </li>
          <li class="slider__item">
            <img src="img/slider/2.jpg" alt="" class="slider__img">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam saepe ipsum vel vitae fugiat ullam, explicabo commodi aperiam cum voluptas omnis provident quis dignissimos adipisci placeat dicta, eveniet ea. Pariatur?</p>
          </li>
          <li class="slider__item">
            <img src="img/slider/3.jpg" alt="" class="slider__img">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam saepe ipsum vel vitae fugiat ullam, explicabo commodi aperiam cum voluptas omnis provident quis dignissimos adipisci placeat dicta, eveniet ea. Pariatur?</p>
          </li>
          <li class="slider__item">
            <img src="img/slider/4.jpg" alt="" class="slider__img">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam saepe ipsum vel vitae fugiat ullam, explicabo commodi aperiam cum voluptas omnis provident quis dignissimos adipisci placeat dicta, eveniet ea. Pariatur?</p>
          </li>
        </ul>
      </section>
